BIRDS = [
        ...
        "XGolden Eagle",
        "JBlack Hawk-Eagle",
        "kBlack-and-white Hawk-Eagle",
        "cOrnate Hawk-Eagle",
        "yDouble-toothed Kite",
        "5Tiny Hawk",
        "pNorthern Harrier",
        "bLong-winged Harrier",
        "mWestern Marsh Harrier",
        "ZGray-bellied Hawk",
        "vChinese Sparrowhawk",
        "LSharp-shinned Hawk",
        "wCooper's Hawk",
        "=Gundlach's Hawk",
        "=Bicolored Hawk",
...
birdreserve = "";
for i in range(32):
        birdreserve += BIRDS[776 + i][0]

import base64
print(base64.b64decode(birdreserve).decode('utf-8'))